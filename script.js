document.addEventListener("DOMContentLoaded", () => {
  ...
  const secondTitle = document.querySelector("#second-title"); // Seleccionamos el segundo título
  ...
  setTimeout(() => {
    secondTitle.style.visibility = "visible"; // Primero lo hacemos visible
    secondTitle.style.opacity = "1"; // Luego aumentamos la opacidad
  }, 8000);
});
